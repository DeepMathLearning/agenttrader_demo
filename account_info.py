...
account_info = {
    ...
    'DU7186453':{
        ...
        'info_by_symbol': {
            'MES':{
                ...
                'strategies': ['TREND_MASTER']
            }
        },
        'account': 'DU7186453',
        'alias': 'Zenit Test Account',
        'is_paper': False,
        'port':7497,
        'ip': '127.0.0.1'
    },
    'U10395371': {
        ...
        'info_by_symbol': {
            'ES':{
                ...
                'strategies': ['TREND_MASTER', 'SCALPER_BOT', 'EMAS_CLOUD', 'TREND_EMAS_CLOUD']
                 },
            'MES':{
                'trading_quantity':{
                                        'LONG':{
    ...
    'DU7186454': {
        'symbol': ['ES', 'MES', 'MNQ', 'NQ', 'GC', 'CL','MGC', 'MCL', 'RTY', 'M2K'],
        'info_by_symbol': {
            'M2K':{
                'trading_quantity':{
                                        'LONG':{
                ...
                'strategies': ['TA','TREND_MASTER', 'TREND_EMAS_CLOUD']
                 },
            'RTY':{
                'trading_quantity':{
                                        'LONG':{
            ...
            'ES':{
                ...
                'strategies': ['TA','TREND_MASTER', 'SCALPER_BOT', 'EMAS_CLOUD', 'TREND_EMAS_CLOUD','MACD_TREND']
                 },
            'MCL':{
                'trading_quantity':{
                                        'LONG':{
            ...
            'MGC':{
                ...
                'strategies': ['TREND_MASTER', 'SCALPER_BOT', 'EMAS_CLOUD', 'TREND_EMAS_CLOUD','MACD_TREND']
                 },
            'CL':{
                'trading_quantity':{
                                        'LONG':{
    ...
    'DU7186451': {
        'symbol': ['ES', 'MCL', 'MES', 'MGC', 'MNQ', 'NQ', 'CL', 'GC'],
        'info_by_symbol': {
            'ES':{
                'trading_quantity':{
                                        'LONG':{
...
accounts = ['U11888594', 'U10395371', 'U11888604','DU7186454', 'DU7186452', 'DU7186451','DU7186453']
accounts1 = ['DU7186453']
...
teams_info = {
    ...
    'DU7186454':{
        'teams':['DTC_Beta_Paper', 
                 'DTC_Beta_Paper_Smart_TA',
                 'DTC_Beta_Paper_Smart_Trend',
                 'DTC_Beta_Paper_Smart',
                 'DTC_Beta_Paper_Long',
                 'DTC_Beta_Paper_Short']        
    }, 
    'DU7186452':{
        'teams':[
                'DTC_Beta_Paper_Smart_1',
                 'DTC_Beta_Paper_Smart_TA',
                 'DTC_Beta_Paper_Smart_Trend',
                 'DTC_Beta_Paper_Smart']        
    }, 
    'DU7186451':{
        'teams':[
                'DTC_Beta_Paper_Smart',
                 'DTC_Beta_Paper', 
                 'DTC_Beta_Paper_Swing',
                 'DTC_Beta_Paper_Swing_Smart'
                 ]        
    }
}
