...
@echo off
title TREND_EMAS_CLOUD GC short 15m Paper Account 2
REM Nombre del entorno virtual
set env_name=%userprofile%\zenit

REM Ruta al archivo Python
set python_file=zenit_TRENDEMASCLOUD_strategy.py
...
set interval=15m
set trading_class=GC
set multiplier=100
set accept_trade=short
set lastTradeDateOrContractMonth=20240227
set quantity=0
